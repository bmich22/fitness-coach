# Jane Smith Fitness Coach
Jane Smith Fitness Coach is the professional page for a person named Jane Smith and she is a Fitness Coach.  The site is targeted to people in the Munich area that are looking for a personal fitness coach or to join group classes that take place in the Munich area. For Jane Smith, the goal of the page is to collect email addresses so she can grow her email list.  This way she can send monthly updates to her email subscribers with her updated schedule and additional information about her classes. 
## Mockups

![screenshot](readme-images/mockup-jane-smith-fitness-coach.png) 

## UX
The goal of Jane Smith Fitness Coach is to add people to her email address list so more people know about her classes. It was designed to be easy to navigate and to provide users with general information about Jane, and the opportunity to sign up for the email list so they can be informed about her classes on a monthly basis.  The look is soft and simple, so users are not intimidated and to convey Jane's personality and the idea that fitness is for everyone. The site is responsive, so it is easy to follow on all screen sizes.  

## Color Scheme
The color scheme for Jane Smith Fitness Coach is welcoming and on the soft side so that users of any age or sex will feel welcome at the site.
...
## Typography
Jane Smith Fitness Coach uses one font, Montserrat, utilizing Montserrat bold for the heading text and Montserrat normal for the paragraph text.  
## User Stories 
### New Users
As a new user I would come to Jane Smith Fitness Coach either by a google search or a link from a gym or fitness center where Jane Smith is an instructor.  I want to find information about Jane's background as an instructor and I want to find out where, when and what she teaches. 
### Returning Users
...
| ---------------- | ---------------- | ----------------- |
| ![screenshot](readme-images/fitness-coach-mobile.jpg) | ![screenshot](readme-images/fitness-coach-tablet.jpg) | ![screenshot](readme-images/Fitness-coach-desktop.jpg) |
## Features
### Existing
| Feature | Description | Screenshot mobile | Screenshot larger screens |
|-------- | ----------- | ---------- | ---------- |
| Favicon | Jane Smith Fitness Coach has a custom favicon in the same color scheme as her page. It displays next to the page title in the browser tab. | ![screenshot](assets/favicon/favicon-jane-fitness-coach-180.png) |
...
### Future Features
Jane Smith Fitness Coach has room to grow and some future features that could enhance the site for both the organizer and the user are:
...
* Details of different classes -- it would be helpful for the users to be able to read about the different classes in case they are not familiar with them
* Blog -- a blog would give users a reason to come back to the site again and again
* Post Current Schedule -- Jane Smith could post her current schedule on her website but this might discourage users from signing up to her email list
...
* FontAwesome.com used for social icons
* Canva.com used to create the favicon for Jane Smith Fitness Coach
* Google Fonts used to add Montserrat font to Jane Smith Fitness Coach

## Testing
### Manual
Manual testing was performed on these aspects of Jane Smith Fitness Coach
* Links - links deliver where they should and social networks open in a new window
* Responsiveness - the site is visually pleasing on all screen sizes
* Form - the form functions and on submission the user is taken to a thank you page opening in a new window with a link back to the home page
